function validateForm() {
    ...
    resetErrors ([peselInput, nameInput, surnameInput, permissionCodeInput], [errorPesel, errorName, errorSurname, errorPermissionCode], 
        errorSummary);
    ...
    if (!checkRequired(peselInput.value)) {
       ...
       if (!checkRequired(nameInput.value)) {
        ...
        nameInput.classList.add("error-input");
        errorName.innerText = "Pole powinno zwiarać od 2 do 60";
        errorName.style.display="block";
        errorName.classList.add("Errors");
    }
      //walidacja nazwiska
      ...
      if (!checkRequired(surnameInput.value)) {
        ...
        surnameInput.classList.add("error-input");
        errorSurname.innerText = "Pole powinno zwiarać od 2 do 60";
        errorSurname.style.display="block";
        errorSurname.classList.add("Errors");
    }
